...
- **[PER_MODALITY_FITTING_PLAN.md](PER_MODALITY_FITTING_PLAN.md)** - Per-modality fitting implementation details
...
The `archive/` subdirectory contains older documentation files kept for reference.
